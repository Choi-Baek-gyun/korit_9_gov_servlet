...
public class OptionalMain {
    public static void main(String[] args) {
        ...
        Optional<String> stringOptional2 = Optional.of("데이터"); // of는 null 불가
        ...
        // optional에서 값 가져오기
//        System.out.println(op.get()); // null일 경우 값을 가져오지 못함
        ...
        op.ifPresentOrElse(
                ...
                () -> System.out.println("값 없으면 이거 실행")
        );

        try {
            String data = op.orElseThrow();
            System.out.println("예외 안터지고 실행: " + data);
